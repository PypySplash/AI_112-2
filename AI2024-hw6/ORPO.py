...
def ORPO_train(args, output_dir):
    ...
    model, tokenizer = FastLanguageModel.from_pretrained(args.model_name, max_length=args.max_length, dtype=torch_dtype)
    ...
    model = FastLanguageModel.get_peft_model(model, lora_params={"alpha": args.lora_alpha, "dimensions": args.lora_dim})
    # utils.YOUR_CODE_HERE
